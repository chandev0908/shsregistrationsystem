  ...
  <div class="page-wrap">
        ...
        <div id="branding">
         ...
         <form action="adminoverview.php" method="POST">
          <input value="Overview" name="overview"style=" hover: blue;position:relative; top:-15px; left:93%; width: 90px; height: 60px; border-radius: 5px; background-color: transparent; font-weight:bold; color: orange;" type="submit">
         </form>
       </div>
       ...
       <form action="./printmanage/printhumms.php" method="POST">
         ...
         <div class="minicontainer">
            <h1> HUMMS DATA </h2>
             ...
             <table align="center" style="position:relative; top:30%";>
               ...
               <tr>
                  <th>  <?php
                    $sqltry = "SELECT count(hummsid) AS total  FROM humms WHERE Gender= 'Male'";
                    ...
                    echo '<h2>'.$numrows.'</h2>'
                     ?></th>
                     <th><?php
                     $sqltry = "SELECT count(hummsid) AS total  FROM humms WHERE Gender= 'Female'";
                     $resulttry = mysqli_query($conn,$sqltry);
                     $valuestry = mysqli_fetch_assoc($resulttry);
                     $numrows = $valuestry['total'];
                     echo 'FEMALE COUNTS :';
         	...
         	?>
          <form action="adminhumms.php" method="post">
          ...
          while($row = mysqli_fetch_array($search_result)):
                       ...
                       <td><?=$row['lrn'];?></td>
         							...
         							<td><?=$row['section'];?></td>
         							<td><?=$row['strand'];?></td>
         							<td><a href="update.php?hummsid=<?=$row['hummsid']?>">UPDATE</a></td>
         							<td><a href="editconn.php?hummsid=<?=$row['hummsid']?>">DELETE</a></td>
         						</tr>
         						<?php
                  endwhile;
         					?>
