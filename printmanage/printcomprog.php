<?php
 ...
 function fetch_data()
 {
   $output = '';
   include('./conn.php');
      $sql = "SELECT * FROM ictprogramming ORDER BY progid ASC";
 ...
 if(isset($_POST["generate_pdf"]))
 {
      ...
      $obj_pdf->SetTitle("ICT-PROGRAMMINGLIST");
      ...
      $content = '';
      $content .= '
      <h4 align="center">ICT-PROGRAMMING STUDENT LIST</h4><br />
 ...
 <html>
      ...
      <body>
           <br />
           <div class="container">
                <h4 align="center"> ICT-PROGRAMMING LIST PDF</h4><br />
