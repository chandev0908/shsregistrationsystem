<?php
 ...
 function fetch_data()
 {
   $output = '';
   include('./conn.php');
      $sql = "SELECT * FROM cookery ORDER BY Gender DESC";
 ...
 if(isset($_POST["generate_pdf"]))
 {
      ...
      $content = '';
      $content .= '
      <h4 align="center">COOKERY STUDENT LIST</h4><br />
 ...
 <html>
      ...
      <body>
           <br />
           <div class="container">
                <h4 align="center"> COOKERY LIST PDF</h4><br />
