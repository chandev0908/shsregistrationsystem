<?php
 ...
 function fetch_data()
 {
   $output = '';
   include('./conn.php');
      $sql = "SELECT * FROM dressmaking ORDER BY Gender DESC";
 ...
 if(isset($_POST["generate_pdf"]))
 {
      ...
      $obj_pdf->SetTitle("DRESSMAKINGLIST");
      ...
      $content = '';
      $content .= '
      <h4 align="center">DRESSMAKING STUDENT LIST</h4><br />
 ...
 <html>
      ...
      <body>
           <br />
           <div class="container">
                <h4 align="center"> DRESSMAKING LIST PDF</h4><br />
