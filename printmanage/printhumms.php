<?php
 ...
 function fetch_data()
 {
   $output = '';
   include('./conn.php');
      $sql = "SELECT * FROM humms ORDER BY hummsid ASC";
 ...
 if(isset($_POST["generate_pdf"]))
 {
      ...
      $content = '';
      $content .= '
      <h4 align="center">HUMMS REGISTERED STUDENT LIST</h4><br />
 ...
 <html>
      ...
      <body>
           <br />
           <div class="container">
                <h4 align="center"> HUMMS LIST PDF</h4><br />
