<?php
 ...
 function fetch_data()
 {
   $output = '';
   include('./conn.php');
      $sql = "SELECT * FROM stem ORDER BY gender DESC";
 ...
 if(isset($_POST["generate_pdf"]))
 {
      ...
      $content = '';
      $content .= '
      <h4 align="center">STEM REGISTERED STUDENT LIST</h4><br />
 ...
 <html>
      ...
      <body>
           <br />
           <div class="container">
                <h4 align="center"> STEM LIST PDF</h4><br />
